...
const UUID = process.env.UUID || 'c16205b3-089c-4951-b972-9f1cb639fb26'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'mocha*.21120173.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNzA2YjA0YTBjN2ZhOWYxMDg2M2FjZDQzYzczNmQyZDgiLCJ0IjoiNTVkZGMyYzYtMDA3Zi00MTM2LTg1ZTEtMmMwNzU2ZjJjZjBhIiwicyI6IlpERTFZVE16TmpRdFpqZ3hNQzAwTlRZekxUZ3dZekl0TmpNeE5UYzVNV00zTldGbSJ9
...
const NAME = process.env.NAME || 'mcha*';                        // 节点名称
